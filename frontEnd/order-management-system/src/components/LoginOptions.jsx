  ...
  return (
    <div className="glass border flex flex-col w-full max-w-76 gap-8 p-6 rounded-2xl shadow-lg text-center sm:min-h-72 lg:max-w-68 xl:size-76 2xl:size-80">
      ...
      <div className="flex my-auto flex-col gap-3 w-[80%] max-w-46 mx-auto lg:gap-5">
        <Link to="/login" className="bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-red-400 transition">
          Sou Cliente
        </ Link>
        <Link to="/login" className="bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-red-400 transition">
          Sou Entregador
        </Link>
        <Link to="/login"n className="bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-red-400 transition">
          Sou Funcionário
        </Link>
      </div>
    </div>
