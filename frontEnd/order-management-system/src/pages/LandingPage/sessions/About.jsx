...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-around container mx-auto max-w-5xl lg:flex-row p-6 gap-6">
      <div className="flex flex-col text-center justify-center h-96 max-w-xl">
        <h1 className="mb-10 text-2xl font-bold">Quem somos</h1>
